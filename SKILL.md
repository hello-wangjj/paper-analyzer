...
1. **准确性优先**：如果论文内容不清楚，明确说明而不是猜测
2. **代码实用性**：生成的代码应该能直接运行或易于修改
3. **教学性**：代码注释应该详细，帮助用户理解实现
4. **PaddlePaddle版本**：严格使用PaddlePaddle 3.2 API，不要使用过时API
5. **Windows兼容**：确保代码路径、多进程等在Windows 11上正常工作
